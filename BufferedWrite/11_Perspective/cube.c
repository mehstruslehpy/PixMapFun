...
int main(int argc, char** argv)
{
	...
	Vector proj_vert5 = perspective_project_vector(vert5,eye_pos,gaze_dir,view_up,view_vol,nx,ny);
	Vector proj_vert6 = perspective_project_vector(vert6,eye_pos,gaze_dir,view_up,view_vol,nx,ny);
	Vector proj_vert7 = perspective_project_vector(vert7,eye_pos,gaze_dir,view_up,view_vol,nx,ny);
	Vector proj_vert8 = perspective_project_vector(vert8,eye_pos,gaze_dir,view_up,view_vol,nx,ny);
	...
	Vector scale_vert5=xform_window_to_view(proj_vert5,wmax,wmin,vmax,vmin);
	Vector scale_vert6=xform_window_to_view(proj_vert6,wmax,wmin,vmax,vmin);
	Vector scale_vert7=xform_window_to_view(proj_vert7,wmax,wmin,vmax,vmin);
	Vector scale_vert8=xform_window_to_view(proj_vert8,wmax,wmin,vmax,vmin);
	...
	draw_segment(blue,scale_vert2,scale_vert4,frame_buffer,X_BOUND,Y_BOUND);
	draw_segment(blue,scale_vert4,scale_vert3,frame_buffer,X_BOUND,Y_BOUND);
	draw_segment(blue,scale_vert3,scale_vert1,frame_buffer,X_BOUND,Y_BOUND);
	draw_segment(red,scale_vert5,scale_vert6,frame_buffer,X_BOUND,Y_BOUND);
	draw_segment(red,scale_vert6,scale_vert8,frame_buffer,X_BOUND,Y_BOUND);
	draw_segment(red,scale_vert8,scale_vert7,frame_buffer,X_BOUND,Y_BOUND);
	draw_segment(red,scale_vert7,scale_vert5,frame_buffer,X_BOUND,Y_BOUND);
	draw_segment(green,scale_vert1,scale_vert5,frame_buffer,X_BOUND,Y_BOUND);
	draw_segment(green,scale_vert2,scale_vert6,frame_buffer,X_BOUND,Y_BOUND);
	draw_segment(green,scale_vert3,scale_vert7,frame_buffer,X_BOUND,Y_BOUND);
	draw_segment(green,scale_vert4,scale_vert8,frame_buffer,X_BOUND,Y_BOUND);
	...
	debug_print_vector("DEBUG:Projected cube vert2:",&proj_vert2);
	debug_print_vector("DEBUG:Scaled cube vert2:",&scale_vert2);
	printf("\n");

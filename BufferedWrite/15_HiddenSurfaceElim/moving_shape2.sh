...
#2048 2048 2048    0.25 1 0    0 0 -1
for ((i=0;i<100;i++))
do
	echo $1.txt
	./shape_noview.sh $(echo $i*\(10\)+2048|bc -l) $(echo $i*\(-10\)+2048|bc -l) $(echo -30*$i+2048|bc -l)\
					$(echo $i*\(0.0001\)+0.25|bc -l) $(echo 0.001*$i+1|bc -l) $(echo $i*\(-0.01\)+0|bc -l)\

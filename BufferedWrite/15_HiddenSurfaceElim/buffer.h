...
//void draw_wireframe(Wireframe,Vector,Pixel**,int,int);
//void draw_bsp_tree(BSPNode*,Vector,Pixel**,int,int);
...
//void fillcolor_triangle_solid(Pixel,Triangle,Pixel**,int,int);
